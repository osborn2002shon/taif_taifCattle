...
GO
CREATE FUNCTION [dbo].[makeSecret](@plainText NVARCHAR(MAX))
RETURNS VARBINARY(MAX)
AS
BEGIN
    RETURN EncryptByPassPhrase('TaIFT', @plainText)
END
GO
/****** Object:  UserDefinedFunction [dbo].[showSecret]    Script Date: 2025/10/27 下午 12:26:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE FUNCTION [dbo].[showSecret](@cipher VARBINARY(MAX))
RETURNS NVARCHAR(100)
AS
BEGIN
    DECLARE @plain NVARCHAR(MAX)
    SET @plain = CONVERT(NVARCHAR(MAX), DecryptByPassPhrase('TaIFT', @cipher))
    RETURN @plain
END
GO
/****** Object:  Table [dbo].[Cattle_History]    Script Date: 2025/10/27 下午 12:26:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Cattle_List]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Cattle_TypeCattle]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Cattle_TypeHistory]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Data_DataExchangeLog]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Data_Moa_FarmLog]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Data_Naif_EarTag]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Data_Naif_SlauData]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[List_Farm]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[List_RenderingPlant]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[List_Slaughterhouse]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[System_Config]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[System_Menu]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[System_MenuAu]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[System_MilkSetting]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[System_Taiwan]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[System_UserAccount]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[System_UserAuType]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[System_UserCPWLog]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[System_UserCPWLog](
	[cpwID] [int] IDENTITY(1,1) NOT NULL,
	[accountID] [int] NOT NULL,
	[exAccountID] [int] NOT NULL,
	[pwdHash] [varchar](64) NOT NULL,
	[changeType] [nvarchar](50) NOT NULL,
	[changeDateTime] [datetime] NOT NULL,
 CONSTRAINT [PK__System_U__113CCF77D683A469] PRIMARY KEY CLUSTERED 
(
	[cpwID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[System_UserFPWLog]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[System_UserLog]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[View_CattleHistory]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE VIEW [dbo].[View_CattleHistory]
AS
select 
	tb_main.cattleID, tagNo, 
	hisID, dataDate, hisTypeID, groupName, typeName,
    CASE
        WHEN farmTwID IS NOT NULL THEN '畜牧場'
        WHEN slauTwID IS NOT NULL THEN '屠宰場'
        WHEN plantTwID IS NOT NULL THEN '化製場'
        ELSE NULL
    END as placeType,
	COALESCE(farmTwID, slauTwID ,plantTwID) as placeTwID, city, area,
	COALESCE(farmID, slauID, plantID) as placeID,
	COALESCE(farmName, slauName, plantName) as placeName,
	COALESCE(farmCode, baphiqCode, plantCode) as placeCode,	
	COALESCE(farmOwner, slauOwner, plantOwner) as placeOwner,
	tb_main.memo,
	tb_main.insertType, tb_main.insertDateTime
from (
	select 
		...
		List_Farm.twID as farmTwID,
		List_Slaughterhouse.slauID,
		List_Slaughterhouse.baphiqCode,
		List_Slaughterhouse.slauName,
		List_Slaughterhouse.ownerName as slauOwner,
		List_Slaughterhouse.twID as slauTwID,
		List_RenderingPlant.plantID,
		List_RenderingPlant.plantCode,
		List_RenderingPlant.plantName,
		List_RenderingPlant.owner as plantOwner,
		List_RenderingPlant.twID as plantTwID,
		Cattle_History.memo,
	...
	left join List_Slaughterhouse on Cattle_History.slauID = List_Slaughterhouse.slauID
	left join List_RenderingPlant on Cattle_History.plantID = List_RenderingPlant.plantID
	where Cattle_History.removeDateTime is null
) tb_main
left join Cattle_List on tb_main.cattleID = Cattle_List.cattleID
left join System_Taiwan on ISNULL(ISNULL(farmTwID, slauTwID),plantTwID) = System_Taiwan.twID
GO
/****** Object:  View [dbo].[View_CattleList]    Script Date: 2025/10/27 下午 12:26:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE VIEW [dbo].[View_CattleList]
AS
	select tb_main.*, isnull(milkProduction,-1)'milkProduction' from (
		select
			Cattle_List.cattleID, tagNo, isnull(birthYear,-1)'birthYear', 
			Cattle_TypeCattle.groupOrder, Cattle_TypeCattle.groupName, 
			Cattle_TypeCattle.cattleTypeID, Cattle_TypeCattle.typeName, 	
			case when isnull(tb_status.jouGroup,'') = '' then '正常' else '除籍' end 'cattleStatus',
			case when ISNULL(Cattle_List.birthYear,-1) = -1 then '-1' else year(GETDATE()) - Cattle_List.birthYear end 'cattleAge',
			Cattle_List.cattleMemo, Cattle_List.tagMemo,
			Cattle_List.insertType, Cattle_List.insertDateTime
		from Cattle_List
		left join Cattle_TypeCattle on Cattle_List.cattleTypeID = Cattle_TypeCattle.cattleTypeID
		left join (
			select 
				cattleID, Cattle_TypeHistory.groupName 'jouGroup', count(*)'jouCount' 
			from Cattle_History
			left join Cattle_TypeHistory on Cattle_History.hisTypeID = Cattle_TypeHistory.hisTypeID
			where Cattle_History.removeDateTime is null and groupName = '除籍'
			group by cattleID, Cattle_TypeHistory.groupName
		) tb_status on Cattle_List.cattleID = tb_status.cattleID
		where Cattle_List.removeDateTime is null
	) tb_main
	left join System_MilkSetting on tb_main.cattleAge = System_MilkSetting.age
GO
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_CattleHistory'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_CattleHistory'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_CattleList'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_CattleList'
GO
