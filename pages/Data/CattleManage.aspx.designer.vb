...
Partial Public Class CattleManage

    '''<summary>
    '''DropDownList_groupName 控制項。
    '''</summary>
    '''<remarks>
    '''自動產生的欄位。
    '''若要修改，請將欄位宣告從設計工具檔案移到程式碼後置檔案。
    '''</remarks>
    Protected WithEvents DropDownList_groupName As Global.System.Web.UI.WebControls.DropDownList
    ...
    '''<summary>
    '''DropDownList_cattleStatus 控制項。
    '''</summary>
    '''<remarks>
    '''自動產生的欄位。
    '''若要修改，請將欄位宣告從設計工具檔案移到程式碼後置檔案。
    '''</remarks>
    Protected WithEvents DropDownList_cattleStatus As Global.System.Web.UI.WebControls.DropDownList
    ...
    '''若要修改，請將欄位宣告從設計工具檔案移到程式碼後置檔案。
    '''</remarks>
    Protected WithEvents GridView_data As Global.System.Web.UI.WebControls.GridView
End Class
