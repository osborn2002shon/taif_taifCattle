...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_path" runat="server">
    <i class="fa-solid fa-ban"></i> 除籍批次新增
</asp:Content>
    ...
    <div class="queryBox">
        ...
        <div class="queryBox-body">
            ...
            <div class="alert alert-info mt-4" role="alert">
                ...
                <ul class="mb-0">
                    <li class="mb-2"><strong>牛籍編號 <span class="badge bg-danger ms-1">必填</span></strong>：若找不到既有牛籍，系統會自動建立新牛籍資料。</li>
                    <li class="mb-2"><strong>除籍日期 <span class="badge bg-danger ms-1">必填</span></strong>：須為正確日期格式且不可晚於今日，否則會顯示「日期錯誤」。</li>
                    <li class="mb-2"><strong>類型 <span class="badge bg-danger ms-1">必填</span></strong>：僅接受「其他」或「未使用」，若不符合則會顯示「類型錯誤」。</li>
