<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FPW.aspx.vb" Inherits="taifCattle.FPW" %>
...
<body>
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <h1 class="system-title">忘記密碼</h1>
                <p class="system-subtitle">Forgot Password</p>
            </div>            
                    ...
                    <asp:MultiView ID="MultiView_main" runat="server">
                        ...
                        <asp:View ID="View_verification" runat="server">
                            <div class="form-floating">
                                <asp:TextBox ID="TextBox_email" runat="server" CssClass="form-control" placeholder="請輸入信箱"></asp:TextBox>
                                <asp:Label ID="Label_email" runat="server" AssociatedControlID="TextBox_email">
                                    <i class="fas fa-envelope me-2"></i>信箱
                                </asp:Label>
                            </div>
                            <asp:Button ID="Button_email" runat="server" CssClass="btn btn-login mb-3" Text="確認" />
                            <button type="button" class="btn back-login-btn" id="backLoginBtn">
                                <i class="fas fa-sign-in-alt me-2"></i>返回登入頁面
                            </button>
                        ...
                        <asp:View ID="View_account" runat="server">
                            ...
                            <button type="button" class="btn back-login-btn backFPW">
                                <i class="fas fa-sign-in-alt me-2"></i>返回
                            </button>
    ...
    <script type="text/javascript">
        ...
        $(".backFPW").on("click", function () {
            window.location.href = "FPW.aspx";
        });
    </script>
</body>
</html>
